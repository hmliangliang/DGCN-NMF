...
if __name__ == '__main__':
    ...
    J, FM, ARI, Phi, Hubert, K, RT, precision, recall, F1, NMI, Q = evaluation(np.array(nx.adjacency_matrix(graph).todense()),np.array([y_pred]), np.array([labels]))
    print('J=',round(J,4))
    print('FM=', round(FM, 4))
    print('Phi=', round(Phi, 4))
    print('Hubert=', round(Hubert, 4))
    print('K=', round(K, 4))
    print('RT=', round(RT, 4))
